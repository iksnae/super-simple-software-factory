...
- Scope boundaries
- Risk/unknowns
- Whether it’s iterationable (shippable slice)
...
### 7. Iteration Readiness Decision
Mark each item as one of:
- **Iteration-Ready** (clear, testable, pointed, minimal unknowns)
...
2. **Proposed Backlog State** (table)  
   ...
   - Dependencies / Gaps
   - Status (Iteration-Ready / Needs Clarification / Discovery First / Blocked)
